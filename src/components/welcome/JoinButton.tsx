...
export const JoinButton: React.FC<JoinButtonProps> = ({
  ...
  return (
    <Button
      onClick={onClick}
      isDisabled={disabled}
      className={`w-full py-4 sm:py-5 rounded-2xl font-bold text-white text-sm sm:text-base shadow-xl relative overflow-hidden group ${
        disabled
    ...
    >
      ...
      <span className="relative flex items-center justify-center gap-2">Find Match</span>
    </Button>
  );
};
