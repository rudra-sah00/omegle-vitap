      ...
      >
        {isCameraOn ? (
          ...
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
              d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A2 2 0 0018 13V7a1 1 0 00-1.447-.894l-2 1A1 1 0 0014 8v.586l-2-2V6a2 2 0 00-2-2H7.414l-3.707-3.707zM2 6a2 2 0 012-2h.586L2 1.414V6zm10 8.586l-2-2V14a2 2 0 01-2 2H4a2 2 0 01-2-2v-2.586L10 8.586V14.586z"
              clipRule="evenodd"
            />
          </svg>
        )}
