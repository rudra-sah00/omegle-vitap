...
describe('ChatWindow', () => {
    ...
    it('renders messages correctly', () => {
        const messages = [
            { id: '1', senderId: 'user1', message: 'Hello', timestamp: Date.now(), type: 'text' as const },
            { id: '2', senderId: 'user2', message: 'Hi there', timestamp: Date.now(), type: 'text' as const },
            { id: '3', senderId: 'system', message: 'System message', timestamp: Date.now(), type: 'system' as const },
        ];
