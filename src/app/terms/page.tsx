        ...
        <div className="space-y-8 text-gray-700">
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              This service allows you to communicate with random strangers through video and text chat. 
            ...
            <ul className="list-disc list-inside space-y-2 pl-4">
              ...
              <li>Not share personal information such as addresses, phone numbers, or financial details</li>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              You are solely responsible for your conduct and any content that you submit, post, or display 
              on or via the service. We reserve the right to:
            </p>
            <ul className="list-disc list-inside space-y-2 pl-4">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              warrant that the service will be uninterrupted, secure, or error-free. You use the service 
              at your own risk.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              damages resulting from your use or inability to use the service. You acknowledge that you 
              are solely responsible for any interactions with other users.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              Your safety is important. Please remember:
            </p>
            <ul className="list-disc list-inside space-y-2 pl-4">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              we will provide notice prior to any new terms taking effect. Your continued use of the service 
          ...
          <div className="pt-8 mt-12 border-t border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-2">
              By using this service, you acknowledge that you have read and understood these terms and 
