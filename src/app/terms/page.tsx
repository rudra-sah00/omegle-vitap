...
export const metadata: Metadata = {
  title: 'Terms of Service - Rules & Guidelines | Omegle VITAP',
  description:
    'Read the terms of service for Omegle VITAP random video chat platform. Understand our rules, eligibility requirements, and user conduct guidelines.',
  alternates: {
    canonical: 'https://vitap.in/terms',
  },
  openGraph: {
    title: 'Terms of Service | Omegle VITAP',
    description: 'Terms and conditions for using Omegle VITAP random video chat platform.',
...
export default function TermsPage() {
  const structuredData = {
    ...
    description: 'Terms of service for Omegle VITAP random video chat platform',
    url: 'https://vitap.in/terms',
    isPartOf: {
      '@type': 'WebSite',
      name: 'Omegle VITAP',
        ...
        <main className="max-w-3xl mx-auto px-6 py-16 sm:py-24">
          <header className="mb-16">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Please read these terms carefully before using Omegle VITAP. By accessing or using our
          ...
          <div className="prose prose-slate prose-lg max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-blue-600 hover:prose-a:text-blue-700">
            <section className="mb-12">
              ...
              <p className="text-slate-600 leading-relaxed">
                By accessing and using Omegle VITAP (&quot;the Service&quot;), you accept and agree
                to be bound by the terms and provision of this agreement. In addition, when using
                this Service, you shall be subject to any posted guidelines or rules applicable to
                such services.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 leading-relaxed">
                You must be at least 18 years old and a current student of VIT-AP University to use
                this Service. By using the Service, you represent and warrant that you have the
                right, authority, and capacity to enter into this Agreement and to abide by all of
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 leading-relaxed">
                Interactions on Omegle VITAP are with random strangers. While we strive to maintain
                a safe environment, we cannot control the behavior of users. You acknowledge that
                you are using the service at your own risk. Do not share personal information such
                as your full name, address, phone number, or financial information.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                Omegle VITAP expressly disclaims all warranties of any kind, whether express or
            ...
            <section className="mb-12">
              ...
              <p className="text-slate-600 leading-relaxed">
                Omegle VITAP shall not be liable for any direct, indirect, incidental, special,
