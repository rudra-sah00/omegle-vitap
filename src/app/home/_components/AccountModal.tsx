        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-900 font-mono text-sm bg-gray-50 p-2 rounded break-all">{user.uid}</p>
            </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Display your name during conversations</p>
            </div>
            <button
