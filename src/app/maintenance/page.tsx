      ...
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="pt-8 border-t border-slate-200">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <Link href="/terms" className="text-slate-700 hover:text-slate-900 font-medium underline underline-offset-4 hover:underline-offset-2 transition-all">
              Terms of Service
            </Link>
            <span className="text-slate-300">•</span>
            <Link href="/privacy" className="text-slate-700 hover:text-slate-900 font-medium underline underline-offset-4 hover:underline-offset-2 transition-all">
              Privacy Policy
            </Link>
            <span className="text-slate-300">•</span>
            <Link href="/community-guidelines" className="text-slate-700 hover:text-slate-900 font-medium underline underline-offset-4 hover:underline-offset-2 transition-all">
