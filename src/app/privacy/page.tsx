        ...
        <div className="space-y-8 text-gray-700">
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 pl-4">
              <li>Basic account information (email, display name, profile picture) when you sign in with Google</li>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              subject to Google's Privacy Policy. We recommend reviewing their privacy practices 
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Our service is accessible globally. By using the service, you consent to the 
